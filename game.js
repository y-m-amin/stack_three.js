...
*/
// Import Three.js from a CDN that supports ES Modules
...
function splitBlockAndAddNextOneIfOverlaps() {
  ...
  const overlap = size - overhangSize;
    if(!autopilot){
  const currentScore = stack.length - 1; // Assuming this is how you track score
  const highScore = Math.max(currentScore, sessionStorage.getItem('highScore') || 0);
